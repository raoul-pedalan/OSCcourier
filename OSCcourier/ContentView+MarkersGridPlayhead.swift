...
// triangle + drag/double-click handling). Split out of `body` verbatim — no
// logic changes. @ViewBuilder since these are several top-level sibling
// views. Needs largeurTimeline/totalHeight explicitly since those are
// locals computed in body's GeometryReader, not ContentView members.
