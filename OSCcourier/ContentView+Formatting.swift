...
// Pure time-formatting/parsing helpers. Free functions rather than
// ContentView methods: they depend on nothing but their arguments, so
// any view (including the extracted sub-views) can call them directly
// without needing a reference back to ContentView.
